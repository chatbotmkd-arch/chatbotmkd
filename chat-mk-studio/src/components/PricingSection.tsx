  ...
  const plans = [
    {
      ...
      ctaLink: "/signup",
      features: [
        { text: "8 дена пробен период", included: true },
        { text: "30 кредити (пораки)", included: true },
    ...
    },
    {
      ...
      ctaLink: "/signup",
      features: [
        { text: "300 кредити (пораки) месечно", included: true },
        ...
        { text: "Споделлив линк за chatbot", included: true },
        { text: "Email поддршка", included: true },
      ],
    },
    {
      name: "Про",
      desc: "За растечки бизниси",
      ...
      ctaLink: "/signup",
      features: [
        { text: "500 кредити (пораки) месечно", included: true },
