...
const testimonials = [
  {
    quote: "NexaAI ни помогна да го намалиме времето за одговор на клиентите од 4 часа на под 30 секунди. Нашите клиенти се воодушевени!",
  ...
  {
    quote: "Од кога го воведовме NexaAI, нашиот тим за поддршка заштедува 20+ часа неделно на повторливи прашања.",
